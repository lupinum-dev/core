...
<template>
  <LibPopover v-model:open="isOpen">
    <LibPopoverTrigger
      class="group mx-2 mb-8 flex w-[calc(100%-1rem)] items-center justify-between rounded-lg p-2 text-foreground transition-all duration-150 hover:bg-accent"
    >
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1 text-left">
          ...
          <p class="font-pressura text-sm text-muted-foreground transition-colors duration-150 group-hover:text-accent-foreground">
      ...
      <div class="max-h-[300px] space-y-1 overflow-y-auto">
        ...
        >
          ...
          >
            ...
            >
              <Icon :name="item.icon || 'i-heroicons-bars-3'" class="size-6 text-secondary-foreground" />
            </div>
            <div class="flex-1 text-left">
              <p class="font-heading text-sm">
                {{ item.title }}
              </p>
              <p class="font-pressura text-sm text-muted-foreground">
