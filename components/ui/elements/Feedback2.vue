    ...
    <LibButton variant="outline" size="sm" @click.stop="openDialog(0)">
      ...
      <div class="ml-2 flex">
        <button
          ...
          class="flex size-6 items-center justify-center rounded-full hover:scale-110 hover:text-prime-i-2 focus:outline-none"
          type="button"
          @click.stop="openDialog(index)"
        >
          <Icon :name="icon" class="size-[16px] text-gray-t-3" />
        </button>
      </div>
    </LibButton>
